...
const long SErr_DBand               =  6; 
const long SErr_CmpOp               =  7; 
const long SErr_ConnectionFn        =  8; 
const long SErr_ConnectionOp        =  9; 
const long SErr_FilterOp            =  10;
const long SErr_GetAbsFn            =  11;
const long SErr_GetCmpFn            =  12;
const long SErr_GetFn               =  13;
const long SErr_GetProfileFn        =  14;
const long SErr_GetRevFn            =  15;
const long SErr_GetSqrFn            =  16;
const long SErr_GetSqrtFn           =  17;
const long SErr_InvertOp            =  18;
const long SErr_MissingOPCTag       =  19;
const long SErr_Modifier            =  20;
const long SErr_NoiseOp             =  21;
const long SErr_OscillatorOp        =  22;
const long SErr_ProfileOp           =  23;
const long SErr_Range               =  24;
const long SErr_RangeOp             =  25;
const long SErr_RemoveItem          =  26;
const long SErr_ScaleOp             =  27;
const long SErr_SetClientHandles    =  28;
const long SErr_SetFn               =  29;
const long SErr_SetRevFn            =  30;
const long SErr_SetOnRiseFn         =  31;
const long SErr_SetOnFallFn         =  32;
const long SErr_SlotExcluded        =  33;
const long SErr_Span                =  34;
const long SErr_SqrOp               =  35;
const long SErr_SqrtOp              =  36;
const long SErr_TooManyConnectFns   =  37;
const long SErr_TooManyConnects     =  38;
const long SErr_Unknown             =  39;
const long SErr_NotLoaded           =  40;
const long SErr_MissingSimTag       =  41;
const long SErr_ReadSubs            =  42;
const long SErr_ProfNotDone         =  43;
const long SErr_InvalidFilename     =  44;
const long SErr_SetValue            =  45;
const long SErr_SetValueDevice      =  46;
const long SErr_ApplySpanInComing   =  47;
const long SErr_ApplyDBandInComing  =  48;
const long SErr_ApplySpanOutGoing   =  49;
const long SErr_ApplyRangeLink2Slot =  50;
const long SErr_PotentialRecursion  =  51;
