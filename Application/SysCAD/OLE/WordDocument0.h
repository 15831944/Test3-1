...
// CWordDocument0 wrapper class

class CWordDocument0 : public COleDispatchDriver
{
public:
	CWordDocument0(){} // Calls COleDispatchDriver default constructor
	CWordDocument0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordDocument0(const CWordDocument0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
