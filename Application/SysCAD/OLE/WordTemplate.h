...
// CWordTemplate wrapper class

class CWordTemplate : public COleDispatchDriver
{
public:
	CWordTemplate(){} // Calls COleDispatchDriver default constructor
	CWordTemplate(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWordTemplate(const CWordTemplate& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
