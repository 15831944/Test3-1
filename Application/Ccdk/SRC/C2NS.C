...
/*----------------------------------------------------------------------*/
BBS_PRIVATE DML_LIST c2n_appr_arc ( nurb, parm0, parm1, 
            dir, acc, arc_list, parm_list ) 
/*----------------------------------------------------------------------*/
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
/*!!!!!!!!                                                      !!!!!!!!*/
/*!!!!!!!!(C) Copyright 1989, 1990, 1991 Building Block Software!!!!!!!!*/
...
INT dir ;
REAL acc ;
DML_LIST arc_list, parm_list ;
{
    char *P=NULL;  /* FORCE A CRASH; */
    *P=1;

    (void) c2n_setup_curv_extr ( nurb ) ;
    
    RETURN NULL;


/** CNM c2s_appr_arc DOES NOT EXIST
    RETURN ( c2s_appr_arc ( C2_NURB_CTPT(nurb), C2_NURB_N(nurb), 
            C2_NURB_D(nurb), C2_NURB_KNOT(nurb), C2_NURB_W(nurb), 
            C2_NURB_CURV_EXTR(nurb), C2_NURB_CURV_EXTR_NO(nurb), 
            parm0, parm1, dir, acc, arc_list, parm_list ) ) ;
**/
}
