...
STRING handle ;
{
    DXF_ENTITY_HANDLE_SET(entity, handle ) ;
    if ( DXF_ENTITY_IS_INSERT(entity) )
        dml_apply_data ( DXF_INSERT_ATTRS(entity), 
            dxf_set_entity_handle, handle ) ;
    else if ( DXF_ENTITY_IS_PLINE(entity) )
        dml_apply_data ( DXF_PLINE_VLIST(entity), 
            dxf_set_entity_handle, handle ) ;
}
...
STRING ltype ;
{
    DXF_ENTITY_LTYPE_SET(entity, ltype ) ;
    DXF_ENTITY_LTYPE_STATUS(entity) = DXF_LTYPE_BYENT ;
    if ( DXF_ENTITY_IS_INSERT(entity) )
        dml_apply_data ( DXF_INSERT_ATTRS(entity), 
            dxf_set_entity_ltype, ltype ) ;
    else if ( DXF_ENTITY_IS_PLINE(entity) )
        dml_apply_data ( DXF_PLINE_VLIST(entity), 
            dxf_set_entity_ltype, ltype ) ;
}
...
DXF_ENTITY entity ;
{
    ...
    if ( DXF_ENTITY_IS_INSERT(entity) )
        dml_apply ( DXF_INSERT_ATTRS(entity), dxf_set_entity_ltype_bylayer ) ;
    else if ( DXF_ENTITY_IS_PLINE(entity) )
        dml_apply ( DXF_PLINE_VLIST(entity), dxf_set_entity_ltype_bylayer ) ;
}
...
DXF_ENTITY entity ;
{
    ...
    if ( DXF_ENTITY_IS_INSERT(entity) )
        dml_apply ( DXF_INSERT_ATTRS(entity), dxf_set_entity_color_bylayer ) ;
    else if ( DXF_ENTITY_IS_PLINE(entity) )
        dml_apply ( DXF_PLINE_VLIST(entity), dxf_set_entity_color_bylayer ) ;
}
...
REAL extrusion[3] ;
{
    ...
    if ( DXF_ENTITY_IS_INSERT(entity) )
        dml_apply_data ( DXF_INSERT_ATTRS(entity), 
            dxf_set_entity_extrusion, extrusion ) ;
    else if ( DXF_ENTITY_IS_PLINE(entity) )
        dml_apply_data ( DXF_PLINE_VLIST(entity), 
            dxf_set_entity_extrusion, extrusion ) ;
}
...
DXF_ENTITY entity ;
{
    RETURN ( DXF_ENTITY_LAYER_GET(entity) ) ;
}
...
DXF_ENTITY entity ;
{
    RETURN ( DXF_ENTITY_HANDLE_GET(entity) ) ;
}
...
DXF_ENTITY entity ;
{
    RETURN ( ( DXF_ENTITY_LTYPE_STATUS(entity) == DXF_LTYPE_BYENT ) ? 
        DXF_ENTITY_LTYPE_GET(entity) : NULL ) ;
}
...
DXF_ENTITY entity ;
{
    ...
    if ( template == NULL ) 
        RETURN ( 0.0 ) ;
    r = (REAL*)dx0_get_template ( (char*)DX_ENTITY_ANY(entity), template, 30 ) ;
    RETURN ( *r ) ;
}
#else
...
DXF_ENTITY entity ;
{
    ...
    if ( template == NULL ) 
        RETURN ( 0.0 ) ;
    r = dx0_get_template ( (char*)DX_ENTITY_ANY(entity), template, 30 ) ;
    RETURN ( *r ) ;
}
#endif
...
DXF_ENTITY_DESC descriptor ;
{
    ...
    DXF_ENTITY_LAYER_SET(entity, DXF_DESC_LAYER_GET(descriptor) ) ;
    DXF_ENTITY_HANDLE_SET(entity, DXF_DESC_HANDLE_GET(descriptor) ) ;
    DXF_ENTITY_LTYPE_SET(entity, DXF_DESC_LTYPE_GET(descriptor) ) ;
