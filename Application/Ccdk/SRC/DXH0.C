...
/*GLOBAL*/ static INT DXF_TEMPLATE_1[]     = { 1, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_2[]     = { 2, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_5[]     = { 5, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_6[]     = { 6, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_7[]     = { 7, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_8[]     = { 8, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_40[]    = { 40, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_50[]    = { 50, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_62[]    = { 62, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_70[]    = { 70, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_R2[]    = { 10, 20, DXF_END_CODE } ;
/*GLOBAL*/ static INT DXF_TEMPLATE_R3[]    = { 10, 20, 30, DXF_END_CODE } ;
