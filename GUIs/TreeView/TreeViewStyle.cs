...
namespace PureComponents.TreeView
{
	...
	public class TreeViewStyle
	{
		...
		private Color m_clrFlagsBackColor = Color.Transparent;
		private Color m_clrFlagsFadeColor = Color.White;
		private FillStyle m_FlagsFillStyle = FillStyle.Flat;
		...
		/// <summary>
		/// Gets or sets the back color fo the flags area
		/// </summary>
		[Description("Gets or sets the back color fo the flags area.")]
		[Editor(typeof (ColorUIEditor), typeof (UITypeEditor))]
		public Color FlagsBackColor
		{
			get
			{
				return m_clrFlagsBackColor;
			}
			set
			{
				m_clrFlagsBackColor = value;
				
				Invalidate();
			}
		}
		private bool ShouldSerializeFlagsBackColor()
		{
			return m_clrFlagsBackColor != Color.Transparent;
		}

		/// <summary>
		/// Gets or sets the fade color fo the flags area
		/// </summary>
		[Description("Gets or sets the fade color fo the flags area.")]
		[Editor(typeof (ColorUIEditor), typeof (UITypeEditor))]
		public Color FlagsFadeColor
		{
			get
			{
				return m_clrFlagsFadeColor;
			}
			set
			{
				m_clrFlagsFadeColor = value;
				
				Invalidate();
			}
		}
		private bool ShouldSerializeFlagsFadeColor()
		{
			return m_clrFlagsFadeColor != Color.White;
		}

		/// <summary>
		/// Gets or sets the fillstyle of the flags area.
		/// </summary>
		[Description("Gets or sets the fillstyle color of the flags area.")]
		[DefaultValue(FillStyle.Flat)]
		public FillStyle FlagsFillStyle
		{
			get
			{
				return m_FlagsFillStyle;
			}
			set
			{
				m_FlagsFillStyle = value;
			}
		}
