...
{	
	...
	public class Node : Component, IComparable
	{
		...
		public string Text
		{
			get
			{
				if (GetTreeView().IsDesignMode == false)
		...
		/// <summary>
		/// Gets or sets whether the Node can be collapsed
		/// </summary>
		[Description("Gets or sets whether the Node can be collapsed.")]
		[Category("Behavior")] 
		[DefaultValue(true)]
