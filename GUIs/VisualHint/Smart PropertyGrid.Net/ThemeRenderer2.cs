...
namespace Skybound.Windows.Forms
{
	...
	struct ThemeRenderer
	{
		...
		/// <summary>
		/// Ensures that the Supported and Enabled properties have bee initialized.
		/// </summary>
		...
		static public bool Enabled
		{
			get
			{
                ...
                // TMP check to avoid a null ref exception under .net 3.0
                if (_CommonControlVersion == null)
                    return false;
