  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      if (config.TestUrl(new System.Uri("ipc://SysCAD.Service/Global")))
      {
        ...
        Dictionary<String, Bitmap> modelUnselectedThumbnails = new Dictionary<String, Bitmap>();
        Dictionary<String, Bitmap> modelSelectedThumbnails = new Dictionary<String, Bitmap>();
        Dictionary<String, Bitmap> graphicUnselectedThumbnails = new Dictionary<String, Bitmap>();
        Dictionary<String, Bitmap> graphicSelectedThumbnails = new Dictionary<String, Bitmap>();
        ...
        Application.Run(new TestAppForm(modelUnselectedThumbnails, modelSelectedThumbnails,
          graphicUnselectedThumbnails, graphicSelectedThumbnails, 
          config.ModelStencils, config.GraphicStencils));
      }
    }
  }
}