...
namespace TestApp
{
  partial class TestAppForm
  {
    ...
    /// </summary>
    private void InitializeComponent(Dictionary<String, Bitmap> modelUnselectedThumbnails, Dictionary<String, Bitmap> modelSelectedThumbnails,
    ...
    {
      this.stencilChooser = new SysCAD.StencilChooser(modelUnselectedThumbnails, modelSelectedThumbnails,
