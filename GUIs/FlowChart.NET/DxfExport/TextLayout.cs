...
namespace MindFusion.FlowChartX.Text
{
	/// <summary>
	...
	internal class DrawTextHint
	{
		public DrawTextHint(Graphics graphics, Font font, 
			...
			bool addEllipsis, XmlNode pTextNode, RectangleF pRect , Color crNew, long StartID, long ShapeID, float RA)
		{
			Graphics = graphics;
			Font = font;
			Brush = brush;
		...
		public Color crText = Color.Empty;
		public long TextID = 0;
		public long BoxID = 0;
