...
{
    /// <summary>
    /// Utility class to fetch certain things from the VisualTree.
    /// </summary>
    public class TreeHelper
    {
        ...
        public static FrameworkElement SingleFindUpInTree(Visual parent, IFinderMatchVisualHelper helper)
        {
            helper.StopAfterFirst = true;
            List<FrameworkElement> lst = new List<FrameworkElement>();
            FindMyUpInTree(lst, parent,  helper);
        ...
        public static void FindMyUpInTree(List<FrameworkElement> lst, Visual parent, IFinderMatchVisualHelper helper)
        {
            ...
            else
            {
                ...
                if (feCast != null)
                {
                    ...
                    {
                        // Pass up
                        FindMyUpInTree(lst, feNewParent,  helper);
                    }
                }
            }
        }
