  ...
  switch (m_Op)
    ...
    case Op_MUFixed:
      ...
      switch (m_Meas1.m_eType)
        ...
        case Type_Mole:    
          ...
          DDB.Text(S());
          DDB.Double("", "Rqd.MakeUp.QMl",  DC_QKgMl,  "kmol/s", &m_RqdSetPoint,  this, isResult|DupHandlesOk);  
        ...
        case Type_Volume:  
          ...
          DDB.Text(S());
          DDB.Double("", "Rqd.MakeUp.Qv",   DC_Qv,     "L/s",    &m_RqdSetPoint,  this, isResult|DupHandlesOk);  
        ...
        case Type_NVolume: 
          ...
          DDB.Text(S());
          DDB.Double("", "Rqd.MakeUp.NQv",  DC_NQv,    "NL/s",   &m_RqdSetPoint,  this, isResult|DupHandlesOk);  
    ...
    case Op_MURatio:
      ...
      switch (m_Meas1.m_eType)
        ...
        case Type_Mass:
          {
          DDB.Double("", "Rqd.QmRatio",    DC_Frac,   "",         &m_RqdSetPoint,    this, isResult|DupHandlesOk); 
        ...
        case Type_Mole:     
          {
          DDB.Double("", "Rqd.QMlRatio",   DC_Frac,   "",         &m_RqdSetPoint,    this, isResult|DupHandlesOk); 
        ...
        case Type_Volume:   
          {
          DDB.Double("", "Rqd.QvRatio",    DC_Frac,   "",         &m_RqdSetPoint,    this, isResult|DupHandlesOk); 
        ...
        case Type_NVolume:  
          {
          DDB.Double("", "Rqd.NQvRatio",   DC_Frac,   "",         &m_RqdSetPoint,    this, isResult|DupHandlesOk); 
    ...
    case Op_PrdFlow:
      ...
      switch (m_Meas1.m_eType)
        ...
        case Type_Mass:    
          ...
          Strng S("Mass flow ", m_Meas1.Description(false));
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.Qm",     DC_Qm,     "kg/s",   &m_RqdSetPoint,  this, isResult|DupHandlesOk);  
          DDB.Double("", "Meas.Feed.Qm",    DC_Qm,     "kg/s",   &m_MeasFeed,     this, isResult|InitHidden);  
          DDB.Double("", "Meas.MakeUp.Qm",  DC_Qm,     "kg/s",   &m_MeasMkUp,     this, isResult|InitHidden);  
        ...
        case Type_Mole:    
          ...
          Strng S("Molar flow ", m_Meas1.Description(false));
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.QMl",    DC_QKgMl,  "kmol/s", &m_RqdSetPoint,  this, isResult|DupHandlesOk);  
          DDB.Double("", "Meas.Feed.QMl",   DC_QKgMl,  "kmol/s", &m_MeasFeed,     this, isResult|InitHidden);  
          DDB.Double("", "Meas.MakeUp.QMl", DC_QKgMl,  "kmol/s", &m_MeasMkUp,     this, isResult|InitHidden);  
        ...
        case Type_Volume:  
          ...
          Strng S("Volume flow ", m_Meas1.Description(false));
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.Qv",     DC_Qv,     "L/s",   &m_RqdSetPoint,  this, isResult|DupHandlesOk);  
          DDB.Double("", "Meas.Feed.Qv",    DC_Qv,     "L/s",   &m_MeasFeed,     this, isResult|InitHidden);  
          DDB.Double("", "Meas.MakeUp.Qv",  DC_Qv,     "L/s",   &m_MeasMkUp,     this, isResult|InitHidden);  
        ...
        case Type_NVolume: 
          ...
          Strng S("NVolume flow ", m_Meas1.Description(false));
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.NQv",    DC_NQv,    "NL/s",  &m_RqdSetPoint,  this, isResult|DupHandlesOk);  
          DDB.Double("", "Meas.Feed.NQv",   DC_NQv,    "NL/s",  &m_MeasFeed,     this, isResult|InitHidden);  
          DDB.Double("", "Meas.MakeUp.NQv", DC_NQv,    "NL/s",  &m_MeasMkUp,     this, isResult|InitHidden);  
    ...
    case Op_PrdComp:
      ...
      switch (m_Meas1.m_eType)
        ...
        case Type_Mass:     
          ...
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.QmFrac",     DC_Frac, "%",  &m_RqdSetPoint,  this, isResult|DupHandlesOk); 
        ...
        case Type_Mole:     
          ...
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.QMlFrac",    DC_Frac, "%",  &m_RqdSetPoint,  this, isResult|DupHandlesOk); 
        ...
        case Type_Volume:   
          ...
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.QvFrac",     DC_Frac, "%",  &m_RqdSetPoint,  this, isResult|DupHandlesOk); 
        ...
        case Type_NVolume:  
          ...
          DDB.Text(S());
          DDB.Double("", "Rqd.Prod.NQvFrac",    DC_Frac, "%",  &m_RqdSetPoint,  this, isResult|DupHandlesOk); 
    ...
    case Op_PrdConc:
      ...
      DDB.Text(S());
      DDB.Double("", "Rqd.Prod.Conc",     DC_Conc, "g/L",  &m_RqdSetPoint,     this, isResult|DupHandlesOk); 
    ...
    case Op_PrdTemp:
      {
      DDB.Double("", "Rqd.Prod.Temp",     DC_T, "C",  &m_RqdSetPoint,     this, isResult|DupHandlesOk); 
    ...
    case Op_PrdTChg:
      {
      DDB.Double("", "Rqd.Prod.TChg",     DC_dT, "C",  &m_RqdSetPoint,     this, isResult|DupHandlesOk); 
