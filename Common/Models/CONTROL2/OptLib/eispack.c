...
#define dabs(x) (UNAC_DOUBLE)abs(x)
...
/* This routine returns the absolute value of X times
   the sign of Y. It is included because the following code
   was converted from fortran and it is a fortran function.
*/
...
UNAC_INT balanc_( integer *nm, integer *n ,
		  UNAC_DOUBLE *a,
...

{
	...
	/* Local variables */
	static integer iexc;
	static UNAC_DOUBLE c, f, g;
	static integer i, j, k, l, m;
	static UNAC_DOUBLE r, s, radix, b2;
	static integer jj;
...
UNAC_INT balbak_(integer *nm, integer *n, integer *low, integer *igh,
					  UNAC_DOUBLE *scale,
					  integer *m ,
					  UNAC_DOUBLE *z )
...
UNAC_INT cdiv_(UNAC_DOUBLE *ar,UNAC_DOUBLE *ai, UNAC_DOUBLE *br, 
					UNAC_DOUBLE *bi, UNAC_DOUBLE *cr, UNAC_DOUBLE *ci )
					
{
	/* System generated locals */
	UNAC_DOUBLE d__1, d__2;
	
	/* Local variables */
	static UNAC_DOUBLE s, ais, bis, ars, brs;
...
/*        UNAC_INT contains information on the rows and columns */
...
UNAC_INT elmhes_(integer *nm,integer *n, integer *low, integer *igh,
					  UNAC_DOUBLE *a,
					  integer *int_ )
...
/* Subroutine */ 
UNAC_INT eltran_(integer *nm,integer *n,integer *low,integer *igh,
					  UNAC_DOUBLE *a,
					  integer *int_,
					  UNAC_DOUBLE *z)
...
/* Subroutine */ 
UNAC_INT hqr_(integer *nm, integer *n, integer *low, integer *igh,
				  ...
				  
{
	...
	/* Builtin functions */
	/*    UNAC_DOUBLE sqrt(), d_sign();*/
	
	/* Local variables */
	static UNAC_DOUBLE norm;
	static integer i, j, k, l, m;
	static UNAC_DOUBLE p, q, r, s, t, w, x, y;
	static integer na, en, ll, mm;
	static UNAC_DOUBLE zz;
	static logical notlas;
	static integer mp2, itn, its, enm2;
	static UNAC_DOUBLE tst1, tst2;
...
L160:
	...
	/*     .......... UNAC_DOUBLE qr step involving rows l to en and */
	/*                columns m to en .......... */
	i__1 = na;
	for (k = m; k <= i__1; ++k) {
		notlas = k != na;
...
static UNAC_DOUBLE c_b49 = 0.;

/* Subroutine */ 

UNAC_INT hqr2_(integer *nm, integer *n, integer *low, integer *igh,
					...
					
{
	...
	UNAC_DOUBLE d__1, d__2, d__3, d__4;
	...
	static UNAC_DOUBLE ra, sa;
	static integer ll, mm, nn;
	static UNAC_DOUBLE vi, vr, zz;
	static logical notlas;
	static integer mp2, itn, its, enm2;
	static UNAC_DOUBLE tst1, tst2;
...
L720:
		...
		cdiv_(&c_b49, &d__1, &d__2, &q, &h[na + na * h_dim1], &h[na + en*h_dim1]);
L730:
		h[en + na * h_dim1] = 0.;
		h[en + en * h_dim1] = 1.;
		enm2 = na - 1;
...
UNAC_INT rg_(integer *nm, integer *n ,
