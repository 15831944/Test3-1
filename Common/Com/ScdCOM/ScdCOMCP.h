...
template <class T>
class CProxy_ISysCADCmdEvents : public IConnectionPointImpl<T, &DIID__ISysCADCmdEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	HRESULT Fire_OnUpNAbout(LONG result)
	{
	...
	HRESULT Fire_OnProjectLoaded(LONG result)
	{
    AtlTrace("Fire_OnProjectLoaded %08x\n", GetCurrentThreadId());	
    CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		CComVariant* pvars = new CComVariant[1];
	...
	HRESULT Fire_OnProjectSaved(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnProjectClosed(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnSetTag(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnGetTag(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnStepProbal(LONG Flags)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnStepDynamic(LONG Flags)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnStop(LONG Flags)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnIdle(LONG Flags)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnSnapshotLoaded(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnSnapshotSaved(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnScenarioLoaded(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnScenarioSaved(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnBacktrackLoaded(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnBacktrackSaved(LONG result)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnVariableSet(LONG Source, LONG SequenceNo, BSTR Tag, VARIANT Value, BSTR CnvTxt)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
