...
const long  ComCmd_Wait                           = 31;
const long  ComCmd_WaitCount                      = 32;
const long  ComCmd_WaitTillSteadyState            = 33;
const long  ComCmd_WaitTillStop                   = 34;
const long  ComCmd_ResetWait                      = 35;
const long  ComCmd_Report_GetValues               = 36;
const long  ComCmd_Report_Trend                   = 37;
const long  ComCmd_Report_SetValues               = 38;
const long  ComCmd_Report_SaveAndClose            = 39;
const long  ComCmd_Report_ExecuteMacro            = 40;
const long  ComCmd_Report_Process                 = 41;
