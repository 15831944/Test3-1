// Alunorte.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include <afxdllx.h>

#define __ALUNORTE_CPP
...
static AFX_EXTENSION_MODULE AlunorteDLL = { NULL, NULL };
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	{
		TRACE1("Alunorte.DLL Initializing %08x!\n", hInstance);

		// Extension DLL one-time initialization
		if (!AfxInitExtensionModule(AlunorteDLL, hInstance))
      return 0;

		// Insert this DLL into the resource chain
		new CDynLinkLibrary(AlunorteDLL);

		if (!MakeVersionOK("Alunorte.DLL", _MAKENAME, SCD_VERINFO_V0, SCD_VERINFO_V1, SCD_VERINFO_V2, SCD_VERINFO_V3))
      return 0;
  ...
  //  ForceLoadModelLibrary();
	...
	{
		TRACE0("Alunorte.DLL Terminating!\n");
		AfxTermExtensionModule(AlunorteDLL);
	}
	return 1;   // ok
}
