...
DLX void  EXPENTRY ZpVersion(ZpVer far *);
DLX int   EXPENTRY ZpInit(LPZIPUSERFUNCTIONS lpZipUserFunc);
DLX BOOL  EXPENTRY ZpSetOptions(LPZPOPT Opts);
DLX ZPOPT EXPENTRY ZpGetOptions(void);
DLX int   EXPENTRY ZpArchive(ZCL C);
