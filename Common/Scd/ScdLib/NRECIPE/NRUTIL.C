...
//extern void _cdecl dbgpln(char * fmt, ...);
//extern void dbgp(char * fmt, ...);

// NBNB Redefinitiuon see NRutil.h
typedef void (*CDBGPFN)(char * fmt, ...);

void DumpA(char *T, CDBGPFN dbgp, double **a, long nrl, long nrh, long ncl, long nch, char *Fmt)
  {
  int i,j;
