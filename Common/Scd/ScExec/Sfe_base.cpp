...
void DumpClsBalance(bool DoCompact, bool DoSummary, CWnd *pWnd, CNodeBalanceInfo & Balance)
  ...
  for (int iJoin=0; iJoin<B.m_Joins.GetSize(); iJoin++)
    ...
    DumpStrD(S, B, "Mass In",                 "kg/s",     true,  "NdAudit.[%i].MassIn (kg/s)",                iJoin, "%.18g", J.m_JoinMassFlwIn,  "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Mass flow in through IO"                                                    );
    DumpStrD(S, B, "Mass Gain",               "kg/s",     true,  "NdAudit.[%i].MassGain (kg/s)",              iJoin, "%.18g", J.m_JoinMassGain,   "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Mass added by the Model"                                                    );
    DumpStrD(S, B, "Mass Gain Rct",           "kg/s",     true,  "NdAudit.[%i].MassGain.RCT (kg/s)",          iJoin, "%.18g", J.m_RCTMassGain,    "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Mass added by a Reaction Block"                                             );
    DumpStrD(S, B, "Mass Out",                "kg/s",     true,  "NdAudit.[%i].MassOut (kg/s)",               iJoin, "%.18g", J.m_JoinMassFlwOut, "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Mass flow out through IO"                                                   );
    DumpStrD(S, B, "Total Heat In",           "kJ/s",     true,  "NdAudit.[%i].TotalHeatIn (kJ/s)",           iJoin, "%.18g", J.m_JoinHfIn,       "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Total Heat flowing in (Sensible + Heat of formation)"                       );
    DumpStrD(S, B, "Total Heat Gain",         "kJ/s",     true,  "NdAudit.[%i].TotalHeatGain (kJ/s)",         iJoin, "%.18g", J.m_JoinHfGain,     "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Total Heat Associated with MassGain"                                        );
    DumpStrD(S, B, "Total Heat Gain Rct",     "kJ/s",     true,  "NdAudit.[%i].TotalHeatGain.RCT (kJ/s)",     iJoin, "%.18g", J.m_RCTHfGain,      "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Total Heat Associated with Rct.MassGain"                                    );
    DumpStrD(S, B, "Total Heat Out",          "kJ/s",     true,  "NdAudit.[%i].TotalHeatOut (kJ/s)",          iJoin, "%.18g", J.m_JoinHfOut,      "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Total Heat flowing out"                                                     );
    DumpStrD(S, B, "Power Input",             "kJ/s",     true,  "NdAudit.[%i].PowerIn (kJ/s)",               iJoin, "%.18g", J.m_JoinPowerIn,    "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Heat flow into join from External Heat Source"                              );
    DumpStrD(S, B, "Power Input Rct",         "kJ/s",     true,  "NdAudit.[%i].PowerIn.RCT (kJ/s)",           iJoin, "%.18g", J.m_RCTPowerIn,     "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Heat flow into join from External Heat Source cfg in Reaction Block"        );
    DumpStrD(S, B, "Power Input EHX",         "kJ/s",     true,  "NdAudit.[%i].PowerIn.EHX (kJ/s)",           iJoin, "%.18g", J.m_EHXPowerIn,     "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Heat flow into join from External Heat Source cfg in Environmental Sources" );
    DumpStrD(S, B, "Sens Heat In",            "kJ/s",     true,  "NdAudit.[%i].SensibleHeatIn (kJ/s)",        iJoin, "%.18g", J.m_JoinHsIn,       "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Sensible Heat flowing in"                                                   );
    DumpStrD(S, B, "Sens Heat Gain",          "kJ/s",     true,  "NdAudit.[%i].SensibleHeatGain (kJ/s)",      iJoin, "%.18g", J.m_JoinHsGain,     "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Sensible Heat Associated with MassGain"                                     );
    DumpStrD(S, B, "Sens Heat Gain Rct",      "kJ/s",     true,  "NdAudit.[%i].SensibleHeatGain.RCT (kJ/s)",  iJoin, "%.18g", J.m_RCTHsGain,      "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Sensible Heat Associated with Rct.MassGain"                                 );
    DumpStrD(S, B, "Sens Heat Out",           "kJ/s",     true,  "NdAudit.[%i].SensibleHeatOut (kJ/s)",       iJoin, "%.18g", J.m_JoinHsOut,      "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Sensible Heat flowing out"                                                  );
    DumpStrD(S, B, "VLE Hf Change @ 0",       "kJ/s",     true,  "NdAudit.[%i].VLE.HfChange@0 (kJ/s)",        iJoin, "%.18g", J.m_VLEHsGain,      "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Sensible Heat Change due to Phase changes"                                  );
    DumpStrD(S, B, "HOR.Std @ 0",             "kJ/s",     true,  "NdAudit.[%i].HOR.Std@0 (kJ/s)",             iJoin, "%.18g", J.m_RCTHOR_Std0,    "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "HOR @ 0C Calc by the 'Standard' Specie Model (relies on SDB)"               );
    DumpStrD(S, B, "HOR.Mdl @ 0",             "kJ/s",     true,  "NdAudit.[%i].HOR.Mdl@0 (kJ/s)",             iJoin, "%.18g", J.m_RCTHOR_Mdl0,    "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "HOR @ 0C Calc by the 'Current Specie Model' (may rely on SDB)"              );
    DumpStrD(S, B, "HOR.Used @ 0",            "kJ/s",     true,  "NdAudit.[%i].HOR.Used@0 (kJ/s)",            iJoin, "%.18g", J.m_RCTHOR_Used0,   "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "HOR @ 0C Actually used"                                                     );
    DumpStrD(S, B, "Sens Heat Change",        "kJ/s",     true,  "NdAudit.[%i].SensibleHeatChg (kJ/s)",       iJoin, "%.18g", J.m_JoinHsChg,      "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Sensible Heat Change"                                                       );
    DumpStrD(S, B, "HOR.Diff @ 0",            "kJ/s",     true,  "NdAudit.[%i].HOR.Diff@0 (kJ/s)",            iJoin, "%.18g", J.m_RCTHOR_Diff0,   "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "HOR Difference @ 0C (UsedHOR-MdlHOR)"                                       );
    DumpStrD(S, B, "Total Heat Change",       "kJ/s",     true,  "NdAudit.[%i].TotalHeatChg (kJ/s)",          iJoin, "%.18g", J.m_JoinHfChg,      "", "");    for (int iSpc=0; iSpc<nSpace; iSpc++) AddTxtFld(S, "");                   AddTxtLine(S, "Total Heat Change"                                                          );
