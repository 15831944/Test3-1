	...
	*/
	...
	namespace Mehroz
	{
		...
		{
            public static double DoubleConversionAccuracy = 1E-6;
            ...
            /// <summary>
            /// Implicit conversion of a decimal floating point value to a Fraction
            /// </summary>
			...
			private static Fraction ConvertPositiveDouble(int sign, double inValue)
			{
				...
				while (remainingDigits != Math.Floor(remainingDigits) 
					&& Math.Abs(inValue - (fractionNumerator / fractionDenominator)) > DoubleConversionAccuracy)
				{
