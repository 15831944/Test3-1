...
CShellTube2::CShellTube2(MUnitDefBase *pUnitDef, TaggedObject * pNd) : 
...
CShellTube2::~CShellTube2()
  {
  }

//---------------------------------------------------------------------------

void CShellTube2::Init()
{
...
void CShellTube2::BuildDataFields()
{
...
bool CShellTube2::ConfigureJoins()
  { 
...
bool CShellTube2::EvalJoinPressures()
  {
  if (1)
...
class CCondensateFinder : public MRootFinder
  {
  public:
    CCondensateFinder(CShellTube2 * pTH, MStream &TubeI, MStream &ShellI, MStream &TubeO, MStream &ShellO);
    ~CCondensateFinder();
...
void CShellTube2::DoCondensingHeater(MStream & ShellI, MStream & TubeI, 
...
class CSimpleSolverFn : public MRootFinder
  {
  public:
    CSimpleSolverFn(CShellTube2 * pTH, MStream &TubeI, MStream &ShellI, MStream &TubeO, MStream &ShellO) : 
      MRootFinder("A Desc" ,s_Tol),
...
// actually fixed 
void CShellTube2::DoLiveSteamHeater(MStream & ShellI, MStream & TubeI, MStream & ShellO, MStream & TubeO, MStream & VentO)
{
  TubeO = TubeI;
  ShellO = ShellI;
  m_dUA=m_dHTArea*m_dHTC;
...
void CShellTube2::ClosureInfo(MClosureInfo & CI)
{
  if (CI.DoFlows())
    {
...
void CShellTube2::flowRE(MStream & sIn, MStream & sOut) 
{
