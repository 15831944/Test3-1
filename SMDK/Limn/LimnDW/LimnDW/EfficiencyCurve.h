...
#ifndef  __EFFICIENCYCURVE_H
#define  __EFFICIENCYCURVE_H

//---------------------------------------------------------------------------

class CEfficiencyCurve : public MBaseMethod
  {
  public:
    CEfficiencyCurve(MUnitDefBase * pUnitDef, TaggedObject * pNd);
    virtual void    Init();
  ...
  protected:
    ...
    C_ModelParameters_DiamondWizard_EfficiencyCurve m_DWParms;
