...
static MInOutDefStruct s_IODefs[]=
  ...
  //  Desc;             Name;       Id; Rqd; Max; CnId, FracHgt;  Options;
    ...
    { "Floats",         "Floats",  1,   1,   1,    0,    1.0f,  MIO_Out|MIO_Material },
    { "Sinks",          "Sinks",   2,   1,   4,    0,    1.0f,  MIO_Out|MIO_Material },
    { NULL },
  };

static double Drw_TrompCurve[] = { MDrw_Poly,  -6,10,  6,10,  6,-2, 0,-20, -6,-2, -6,10,
                                   MDrw_Poly,  -6,4, 6,4,
                                   MDrw_Poly,  -6,-2, 6,-2,
                                   MDrw_End };
...
DEFINE_TRANSFER_UNIT(CTrompCurve, "TrompCurve", DLL_GroupName)
void CTrompCurve_UnitDef::GetOptions()
  {
  SetDefaultTag("EC");
  SetDrawing("TrompCurve", Drw_TrompCurve);
  SetTreeDescription("LimnDW:TrompCurve");
...
void CTrompCurve::EvalProducts()
  ...
  try
    ...
    if (QI.IFExists<CLimnStream>())
      ...
      m_DWParms.FloatsStreamID()=1;
      int Ret = _Model_DiamondWizard_TrompCurve (gs_DWCfg.RowCount(),
					 		            			                      gs_DWCfg.ColCount(),
      ...
      if (DoDbg)
        {
        LSO0.Dump("Floats", DoDbg);
        LSO1.Dump("Sinks", DoDbg);
        }
...
//====================================================================================
// Actions
bool CTrompCurve::GetModelAction(CMdlActionArray & Acts)
  {
...
bool CTrompCurve::SetModelAction(CMdlAction & Act)
  {
  switch (Act.iIndex)
    {
    case 0:
