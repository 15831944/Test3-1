...
*/
	...
	*/
	...
	DB.Double("No Load Power"				  ,"NLP",&m_iNoLoadPower					,MF_PARAMETER ,MC_Pwr);
	//DB.Double("Gross Power"				      ,"",&m_oGrossPower					,MF_RESULT    ,MC_Pwr);
	...
	*/
	...
	DB.Double("Average size of Top 20%"		,"",&m_oAverageSizeTop20		,MF_RESULT		,MC_L );
	DB.Double("Mill Pulp Load"				,"",&m_oMillPulpLoad			,MF_RESULT		,MC_Frac );
    DB.ObjectEnd();
...
void CMill_AGSAG::EvalProducts(MBaseMethod &M,
