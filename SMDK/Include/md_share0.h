...
const DDEF_Flags DDEF_SHOWASDEFAULT       = 0x0000080000000000; 
...
const DDEF_Flags DDEF_FLOATFMT            = 0x0020000000000000;
...
const DDEF_Flags DDEF_SMALLVALUE          = 0x0400000000000000;
