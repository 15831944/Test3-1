##   Time-stamp: <2007-05-29 03:18:09 Rod Stephenson Transcritical Pty Ltd>
...
#define DLL_GroupName "${dllGroupName}"dllGroupName=dllGroupName
//--------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
DEFINE_TRANSFER_UNIT(${className}, "${unitName}", ${dllGroupName})
...
###print s1
##
##s2 = Template(makeFile)
##print s2.safe_substitute(dllGroupName=dllGroupName)
