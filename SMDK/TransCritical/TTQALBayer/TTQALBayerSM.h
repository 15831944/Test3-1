...
#ifndef __TTQALBayerSM_H_
#define __TTQALBayerSM_H_
#include "md_headers.h"
#include <vector>

class TTQALBayerSM; // forward declare
...
class TTQALBayerSM : public MSpModelBase, public MIBayer
  {
