...
//   Time-stamp: <2006-09-11 14:48:34 Rod Stephenson Transcritical Pty Ltd>
//===========================================================================
...
class CClassPrecipitator: public MBaseMethod, CPrecip
{
 public:


  CClassPrecipitator(MUnitDefBase *pUnitDef,TaggedObject * pNd);
  virtual ~CClassPrecipitator(void);
