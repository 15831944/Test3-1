...
//   Time-stamp: <2005-03-18 11:17:47 Rod Stephenson Transcritical Pty Ltd>
//===========================================================================
...
class CPrecip : public MBaseMethod
{
 ...
 protected:
  ...
  double m_dCooldQ;
  double m_dCoolFlow;
  double m_dIntCoolVolFlow;
  double m_dCoolArea;
  double m_dCoolHTC;
  double m_dCoolWaterFlow;
  double m_dCoolWaterTin;
  double m_dCoolWaterTout;
  ...
  double   x[8];         // Precipitation Rates */
  double   xo[8];        // Old rates in iterative convergence algoritm  */
  double m_dDamping;
