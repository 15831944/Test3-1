...
#include "stdafx.h"
#define  __EXAMPLESURGE_CPP
#include "examplesurge.h"
#pragma optimize("", off)
...
//// TOGO
//static MInitialiseTest InitTest("SMDK_SUrgeTank");
...
static MInOutDefStruct s_IODefs[]=
  ...
  //  Desc;             Name;       Id;    Rqd; Max; CnId, FracHgt;  Options;
    ...
    { "Product",        "Product",  idProd,  1,  10,    0,    0.0f,  MIO_Out|MIO_Material },
    { "OverFlow",       "OverFlow", idOFlw,  1,   1,    0,    1.0f,  MIO_Out|MIO_Material },
    { NULL },
  };

static double Drw_Tank[] = { MDrw_Poly,  8.,8.,  8.,-8., -8.,-8., -8.,8.,
MDrw_End };

//---------------------------------------------------------------------------

DEFINE_TRANSFER_UNIT(Tank, "Tank", DLL_GroupName)
void Tank_UnitDef::GetOptions()
  {
  SetDefaultTag("Tnk");
  SetDrawing("Tank", Drw_Tank);
...
//void QuickFN(MSpeciePtr p)
//  {
//  double xxx=gs_MVDefn[p].Density();
//  }
...
void Tank::EvalProducts()
  ...
  try
    ...
    bool conn=FlwIOs.Count[idProd]>0;
    MStream &QO = conn ? FlwIOs[FlwIOs.First[idProd]].Stream : QX;
...
//====================================================================================
// Actions
bool Tank::GetModelAction(CMdlActionArray & Acts)
  {
...
bool Tank::SetModelAction(CMdlAction & Act)
  {
  switch (Act.iIndex)
    {
    case 0:
...
bool Tank::GetModelGraphic(CMdlGraphicArray & Grfs)
  {
  CMdlGraphic G0(0, MGT_Simple, true, "Tank Graphic", 1);
...
bool Tank::OperateModelGraphic(CMdlGraphicWnd & Wnd, CMdlGraphic & Grf)
  {
